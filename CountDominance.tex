...
\section{Discussion}
	...
	Relative weights analysis (cite) is a commonly applied alternative to DA that approximates the averaging process between all possible models using singular value decomposition.
	Relative weights analysis has shown some promise in past research (cites), and has been extended to one generalized linear model in published research (i.e., logit regression, cite) but has been subject to sharp criticism (cites) and is not among commonly recommended methods for relative importance (cites). 
